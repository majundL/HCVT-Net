...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt_path', type=str, default='./dataset/Your data path')
    parser.add_argument('--mask_path', type=str, default='./dataset/Your data path')
    parser.add_argument('--mask_test_path', type=str, default='./dataset/Your data path')
